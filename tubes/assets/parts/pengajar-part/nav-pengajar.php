        ...
        <div id="nav-menu" class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li id="Home" class="nav-item">
                    <a class="nav-link active text-md-center" aria-current="page" href="pengajar-view.php">
                ...
                <li id="Teacher" class="nav-item text-md-center">
                    <a class="nav-link" href="jadwal-pengajar.php">
                ...
                <li class="nav-item text-md-center">
                    <a class="nav-link" href="e-book.php">
