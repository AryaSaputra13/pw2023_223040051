        ...
        <tbody class="table-group-divider">
            <tr>
                <form action="" method="post">
                    ...
                    <td>
                        <input type="text" name="NIP" id="NIP" class="form-control" value="<?= $tchr["NIP"]; ?>" required>    
                    </td>
                    <td>
                        <input type="text" name="nama" id="nama" class="form-control" value="<?= $tchr["nama"]; ?>" required>
                    </td>
                    <td>
