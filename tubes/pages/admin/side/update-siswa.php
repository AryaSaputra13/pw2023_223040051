        ...
        <tbody class="table-group-divider">
            <tr>
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $stdt["id"]; ?>">
                    <td>
                        <img src="../../img/pengajarimg/<?= $stdt["foto"]; ?>" width="50" height="50" class="rounded-circle">
                        <input type="file" name="foto" id="foto" class="form-control" style="max-width: 300px; margin: 10px 0 0 0;">
                    </td>
                    <td>
                        <input type="text" name="NIS" id="NIS" class="form-control" value="<?= $stdt["NIS"]; ?>" required>    
                    </td>
                    <td>
                        <input type="text" name="nama" id="nama" class="form-control" value="<?= $stdt["nama"]; ?>" required>
                    </td>
                    <td>
